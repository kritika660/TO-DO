    ...
    >
      <div className="glass-panel w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button type="submit" className="btn-primary justify-center mt-6 py-3 text-lg">
            Create Account
          </button>
        </form>

        <p className="text-center mt-8 text-[var(--text-secondary)]">
          Already have an account? <Link to="/login" className="text-indigo-500 font-semibold hover:underline">Sign in</Link>
        </p>
      </div>
    </motion.div>
  );
